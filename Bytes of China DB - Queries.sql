...
select max(review.rating) as best_rating from review;
...
from dish, categories_dishes, category
where dish.id = categories_dishes.dish_id and category.id = categories_dishes.category_id and dish.hot_and_spicy = true; 
...
select dish.name as dish_name, categories_dishes.dish_id, count(categories_dishes.dish_id) as dish_count
